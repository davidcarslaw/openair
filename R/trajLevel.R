...
##' can be set to \dQuote{frequency} to show the number of back trajectory
...
##' to set \code{method = "hexbin"} for plotting frequencies (not
...
##' passed through the cell (i,j). The criterion for de-termining \eqn{m_{ij}}
##' is controlled by \code{percentile}, which by default is 90. Note also that
...
##' @param pollutant Pollutant to be plotted. By default the trajectory height
##'   is used.
...
##'
##'   For \code{trajLevel}, the argument \code{method = "hexbin"} can be used.
##'   In this case hexagonal binning of the trajectory \emph{points} (i.e. a
##'   point every three hours along each back trajectory). The plot then shows
##'   the trajectory frequencies uses hexagonal binning. This is an alternative
##'   way of viewing trajectory frequencies compared with \code{statistic =
##'   "frequency"}.
##'
...
##'   understand the differences in freqeuncies of the origin of air masses. The
##'   comparsion is made by comparing the percentage change in gridded
##'   frequencies. For example, such a plot could show that the top 10\% of
##'   concentrations of PM10 tend to orginate from air-mass origins to the east.
##'
...
##' @param map Should a base map be drawn? If \code{TRUE} the world base map
...
##' @param parameters From the \code{mapproj} package. Optional numeric vector
...
##' analysis of high-alpine air pollution data. NATO Challenges of Modern
##' Society 18, 595-595.
##'
